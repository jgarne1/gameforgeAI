...
.swAmbientEffect.waterSurfaceShimmer{background:radial-gradient(ellipse at 25% 35%,rgba(160,235,255,.16),transparent 28%),radial-gradient(ellipse at 65% 70%,rgba(210,250,255,.10),transparent 24%),repeating-linear-gradient(115deg,rgba(166,232,255,.00) 0 16px,rgba(166,232,255,.14) 18px 22px,rgba(255,255,255,.08) 23px 25px,rgba(166,232,255,.00) 27px 42px);mix-blend-mode:screen;filter:blur(.25px);animation:swWaterSurfaceShimmer 2.4s linear infinite}
.swAmbientEffect.slowRiverCurrent{background:repeating-linear-gradient(var(--angle),rgba(140,218,255,.00) 0 22px,rgba(140,218,255,.10) 24px 28px,rgba(245,255,255,.08) 30px 32px,rgba(140,218,255,.00) 34px 58px);mix-blend-mode:screen;filter:blur(.4px);animation:swRiverCurrent 1.8s linear infinite}
.swAmbientEffect.waterEdgeFoam{background:radial-gradient(ellipse at 25% 70%,rgba(235,252,255,.42),transparent 42%),radial-gradient(ellipse at 65% 42%,rgba(210,245,255,.30),transparent 44%),repeating-radial-gradient(circle at 50% 50%,rgba(255,255,255,.26) 0 2px,transparent 3px 18px);mix-blend-mode:screen;filter:blur(1.2px);animation:swEdgeFoam 1.65s ease-in-out infinite}
.swAmbientEffect.waterfallCascade{background:repeating-linear-gradient(90deg,rgba(185,242,255,.00) 0 7px,rgba(185,242,255,.18) 8px 11px,rgba(255,255,255,.22) 12px 14px,rgba(185,242,255,.06) 15px 20px),linear-gradient(180deg,rgba(255,255,255,.18),rgba(115,210,255,.12) 40%,rgba(255,255,255,.25));mix-blend-mode:screen;filter:blur(.35px);animation:swWaterfallCascade .55s linear infinite}
.swAmbientEffect.waterfallMist{background:radial-gradient(ellipse at 50% 50%,rgba(215,245,255,.34),rgba(160,225,255,.16) 42%,transparent 74%);mix-blend-mode:screen;filter:blur(7px);animation:swWaterfallMist 3.8s ease-in-out infinite}.swAmbientEffect.waterfallMist i{position:absolute;width:18px;height:8px;border-radius:999px;background:rgba(230,250,255,.24);filter:blur(3px);animation:swMistParticle 4.8s ease-in-out infinite}
.swAmbientEffect.pondRipple:before,.swAmbientEffect.splashRing:before{content:'';position:absolute;inset:18%;border-radius:50%;border:3px solid rgba(135,218,255,.46);box-shadow:0 0 18px rgba(135,218,255,.22);animation:swAmbientRipple 2.2s linear infinite}.swAmbientEffect.pondRipple:after,.swAmbientEffect.splashRing:after{content:'';position:absolute;inset:34%;border-radius:50%;border:2px solid rgba(224,246,255,.35);animation:swAmbientRipple 2.2s linear infinite .7s}.swAmbientEffect.splashRing{animation:swSplashPulse 1.2s ease-out infinite}
@keyframes swWaterSurfaceShimmer{0%{background-position:0 0,0 0,0 0}100%{background-position:18px -8px,-12px 10px,84px 0}}@keyframes swRiverCurrent{to{background-position:96px 0}}@keyframes swEdgeFoam{50%{opacity:.55;transform:scale(1.025)}}@keyframes swWaterfallCascade{to{background-position:0 42px,0 42px}}@keyframes swWaterfallMist{50%{opacity:.55;transform:translateY(8px) scale(1.04)}}@keyframes swMistParticle{50%{transform:translate(22px,-12px);opacity:.25}}@keyframes swSplashPulse{50%{filter:brightness(1.25)}}
