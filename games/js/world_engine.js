...
(function(){
  ...
  function preloadSpriteSheet(){
    ...
    img.onload=function(){
      ...
      SPRITE.rows=12;SPRITE.cols=Math.round(SPRITE.naturalW/128) || 6;SPRITE.w=128;SPRITE.h=128;SPRITE.loaded=true;
    };
