...
## 📱 Mobile Support Rule
- All UI changes MUST include mobile responsiveness (<=768px).
- Do NOT shrink desktop UI — implement mobile-specific layouts.
- Test core flows (Battle Hall, Pet, Mail) on mobile before committing.
